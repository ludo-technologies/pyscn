...
func TestDefaultCloneRequest(t *testing.T) {
	...
	assert.Equal(t, DefaultCloneMinLines, request.MinLines, "Default min lines should match constant")
	assert.Equal(t, DefaultCloneMinNodes, request.MinNodes, "Default min nodes should match constant")
