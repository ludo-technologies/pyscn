...
func TestDefaultCloneRequest(t *testing.T) {
	...
	assert.Equal(t, 0.95, request.Type1Threshold, "Default Type-1 threshold should be 0.95")
	assert.Equal(t, 0.85, request.Type2Threshold, "Default Type-2 threshold should be 0.85")
	assert.Equal(t, 0.70, request.Type3Threshold, "Default Type-3 threshold should be 0.70")
	assert.Equal(t, 0.60, request.Type4Threshold, "Default Type-4 threshold should be 0.60")
