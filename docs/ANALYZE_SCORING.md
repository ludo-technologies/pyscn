...
|---------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|-------------|
| Complexity          | Function-average cyclomatic, cognitive, and nesting metrics plus executable class-scope hotspot maxima | Max of continuous linear penalties:<br/>Function McCabe starts at avg=2, reaches max at avg=15<br/>Function cognitive starts at avg=15, reaches max at avg=25<br/>Function nesting starts at avg=3, reaches max at avg=7<br/>Class maxima use the same metric thresholds | 20          |
