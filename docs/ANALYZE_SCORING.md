...
|---------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|-------------|
| Complexity          | Function-average cyclomatic, cognitive, and nesting metrics | Max of continuous linear penalties:<br/>Function McCabe starts at avg=2, reaches max at avg=15<br/>Function cognitive starts at avg=15, reaches max at avg=25<br/>Function nesting starts at avg=3, reaches max at avg=7 | 20          |
